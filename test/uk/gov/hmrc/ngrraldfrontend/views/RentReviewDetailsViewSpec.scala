...
class RentReviewDetailsViewSpec extends ViewBaseSpec {
  ...
  object Selectors {
    ...
    val annualAmountLabel = "#main-content > div > div.govuk-grid-column-two-thirds > form > div:nth-child(4) > h1 > label"
    val annualAmountHint = "#annualAmount-hint"
    val whatHappensRadioLabel = "#main-content > div > div.govuk-grid-column-two-thirds > form > div:nth-child(5) > fieldset > legend > h1"
    ...
    val hasAgreedRadioLabel = "#main-content > div > div.govuk-grid-column-two-thirds > form > div:nth-child(7) > fieldset > legend > h1"
    ...
    val whoAgreedRadioLabel = "#conditional-has-agreed-new-rent-radio-2 > div > fieldset > legend > h1"
