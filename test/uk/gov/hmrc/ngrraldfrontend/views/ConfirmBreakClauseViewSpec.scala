...
class ConfirmBreakClauseViewSpec extends ViewBaseSpec {
  ...
  private val ngrRadio: NGRRadio = simpleNgrRadio(ConfirmBreakClauseForm.radio)
  val form = ConfirmBreakClauseForm.form.fillAndValidate(ConfirmBreakClauseForm("true"))
