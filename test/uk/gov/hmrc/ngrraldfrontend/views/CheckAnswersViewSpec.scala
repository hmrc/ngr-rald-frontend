...
class CheckAnswersViewSpec extends ViewBaseSpec {
  ...
  object Selectors {
    ...
    val agreedRentChange = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(7) > div:nth-child(3) > dt"
    ...
    val rentIncBusinessRates = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(5) > dt"
    val rentIncWaterCharges = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(6) > dt"
    val rentIncService = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(7) > dt"
    val doesYourRentIncludeParking = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(8) > dt"
    val howManyUncoveredSpacesIncludedInRent = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(9) > dt"
    val howManyCoveredSpacesIncludedInRent = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(10) > dt"
    val howManyGaragesIncludedInRent = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(11) > dt"
    val doYouPayExtraForParkingSpaces = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(12) > dt"
    ...
    val parkingSpacesOrGaragesNotIncludedInYourRent = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(16) > dt"
    val totalCost = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(16) > dt"
    val agreementDate = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(9) > div:nth-child(17) > dt"

    val repairsAndInsuranceLabel = "#main-content > div > div.govuk-grid-column-two-thirds > h2:nth-child(10)"
    val internalRepairs = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(11) > div:nth-child(1) > dt"
    val externalRepairs = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(11) > div:nth-child(2) > dt"
    val buildingInsurance = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(11) > div:nth-child(3) > dt"

    val rentReviewLabel = "#main-content > div > div.govuk-grid-column-two-thirds > h2:nth-child(12)"
    val hasIncludeRentReview = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(13) > div:nth-child(1) > dt"
    val howOftenReviewed = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(13) > div:nth-child(2) > dt"
    val canRentGoDown = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(13) > div:nth-child(3) > dt"

    val repairsAndFittingOutLabel = "#main-content > div > div.govuk-grid-column-two-thirds > h2:nth-child(14)"
    val repairsAndFittingOut = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(15) > div:nth-child(1) > dt"
    ...
    val moneyYouPaidInAdvanceToLandlordAmount = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(15) > div:nth-child(3) > dt"
    ...
    val otherDetailsLabel = "#main-content > div > div.govuk-grid-column-two-thirds > h2:nth-child(18)"
    val hasAnyAffectedRent = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(19) > div:nth-child(1) > dt"
    val otherDetailsReason = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(19) > div:nth-child(2) > dt"
    ...
    val otherReasonAnswer = "#main-content > div > div.govuk-grid-column-two-thirds > dl:nth-child(7) > div:nth-child(2) > dd.govuk-summary-list__value"
  ...
  "CheckAnswersView" must {
    val checkAnswersView = view(
      ...
      firstRentPeriod = createFirstRentPeriodRow(credId = testCredId.value, userAnswers = Some(fullNewAgreementUserAnswers)),
      rentPeriods = createRentPeriodsSummaryLists(credId = testCredId.value, userAnswers = Some(fullNewAgreementUserAnswers)),
    ...
    "show the correct answer for total annual rent in the rent details table" in {
      elementText(Selectors.totalAnnualRentAnswer) mustBe "£12.0"
    }
    ...
    //totalCost
    "show the correct message for How much extra do you pay each year for parking and garages in the rent details table" in {
    ...
    "show the correct answer for How much extra do you pay each year for parking and garages in the rent details table" in {
      elementText(Selectors.totalCostAnswer) mustBe "£12.0"
    }
    ...
    "show the correct answer for building insurance in the repairs and fitting out details table" in {
      elementText(Selectors.repairsAndFittingOutCostAnswer) mustBe "£12.0"
    }
    ...
    "show the correct answer for repairs and fitting out cost in the payments table" in {
      elementText(Selectors.moneyYouPaidInAdvanceToLandlordAmountAnswer) mustBe "£12.0"
    }
