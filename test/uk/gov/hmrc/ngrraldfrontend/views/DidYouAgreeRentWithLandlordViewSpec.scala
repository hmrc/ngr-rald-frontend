...
class DidYouAgreeRentWithLandlordViewSpec extends ViewBaseSpec {
  ...
  private val ngrRadio: NGRRadio = DidYouAgreeRentWithLandlordForm.agreeRentRadio
  val form = DidYouAgreeRentWithLandlordForm.form.fillAndValidate(DidYouAgreeRentWithLandlordForm("true"))
