...
class WhatYourRentIncludesViewSpec  extends ViewBaseSpec {
  ...
  object Selectors {
    ...
    val radio1Label = "#main-content > div > div > form > div > div > div:nth-child(3) > fieldset > legend"
    ...
    val radio3Label = "#main-content > div > div > form > div > div > div:nth-child(7) > fieldset > legend"
    val radio3Hint = "#rentEmptyShellRadio-hint"
    val radio4Label = "#main-content > div > div > form > div > div > div:nth-child(8) > fieldset > legend"
    val radio5Label = "#main-content > div > div > form > div > div > div:nth-child(9) > fieldset > legend"
    val radio6Label = "#main-content > div > div > form > div > div > div:nth-child(10) > fieldset > legend"
