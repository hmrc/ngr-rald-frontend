...
class TellUsAboutRentControllerSpec extends ControllerSpecSupport {
  val pageTitle = "Tell us about your new agreement"
  val view: TellUsAboutYourAgreementView = inject[TellUsAboutYourAgreementView]
  val controller: TellUsAboutRentController = new TellUsAboutRentController(view, mockAuthJourney, mockIsRegisteredCheck, mockNgrConnector, mockRaldRepo, mcc)(mockConfig)
