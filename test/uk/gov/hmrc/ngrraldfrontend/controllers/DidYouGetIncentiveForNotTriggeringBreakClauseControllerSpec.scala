...
class DidYouGetIncentiveForNotTriggeringBreakClauseControllerSpec extends ControllerSpecSupport {
  ...
  val controllerNoProperty: DidYouGetIncentiveForNotTriggeringBreakClauseController = new DidYouGetIncentiveForNotTriggeringBreakClauseController(view = view, authenticate =  mockAuthJourney, getData = fakeData(None), checkRequestSentReference = mockCheckRequestSentReference, formProvider = formProvider, sessionRepository = mockSessionRepository, navigator = mockNavigator, mcc = mcc)(mockConfig, ec)
  val userAnswers: Option[UserAnswers] => DidYouGetIncentiveForNotTriggeringBreakClauseController = answers => new DidYouGetIncentiveForNotTriggeringBreakClauseController(view = view, authenticate =  mockAuthJourney, getData = fakeDataProperty(Some(property), answers), checkRequestSentReference = mockCheckRequestSentReference, formProvider = formProvider, sessionRepository = mockSessionRepository, navigator = mockNavigator, mcc = mcc)(mockConfig, ec)
