...
class MoneyYouPaidInAdvanceToLandlordControllerSpec extends ControllerSpecSupport {
  ...
  val moneyYouPaidInAdvanceToLandlordAnswers: Option[UserAnswers] = userAnswers.set(MoneyYouPaidInAdvanceToLandlordPage, moneyYouPaidInAdvanceToLandlordModel).toOption
