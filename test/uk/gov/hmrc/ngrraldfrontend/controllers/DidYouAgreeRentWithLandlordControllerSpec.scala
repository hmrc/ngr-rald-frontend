...
class DidYouAgreeRentWithLandlordControllerSpec  extends ControllerSpecSupport {
  ...
  val controllerNoProperty: DidYouAgreeRentWithLandlordController = new DidYouAgreeRentWithLandlordController(view, mockAuthJourney, fakeData(None), mockCheckRequestSentReference , mockSessionRepository, mockNavigator, mcc)(mockConfig, ec)
  val controllerProperty: Option[UserAnswers] => DidYouAgreeRentWithLandlordController = answers => new DidYouAgreeRentWithLandlordController(view, mockAuthJourney, fakeDataProperty(Some(property), answers), mockCheckRequestSentReference, mockSessionRepository, mockNavigator, mcc)(mockConfig, ec)
  val didYouAgreeWithTheLandlordAnswers: Option[UserAnswers] = userAnswersWithoutData.set(DidYouAgreeRentWithLandlordPage, true).toOption
