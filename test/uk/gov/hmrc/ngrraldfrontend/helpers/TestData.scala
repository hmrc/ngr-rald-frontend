...
trait TestData {
 ...
 val property: VMVProperty = VMVProperty(
  ...
  val firstRentPeriod: ProvideDetailsOfFirstRentPeriod = ProvideDetailsOfFirstRentPeriod(
 ...
 val secondRentPeriod: ProvideDetailsOfRentPeriod = ProvideDetailsOfRentPeriod(
  endDate = "2025-03-31",
