...
class MoneyYouPaidInAdvanceToLandlordSpec extends TestSupport {
  ...
  "MoneyYouPaidInAdvanceToLandlord" should {
    "deserialize to json" in {
      Json.toJson(moneyYouPaidInAdvanceToLandlord) mustBe moneyYouPaidInAdvanceToLandlordJson
    }
    "serialize to json" in {
      moneyYouPaidInAdvanceToLandlordJson.as[MoneyYouPaidInAdvanceToLandlord] mustBe moneyYouPaidInAdvanceToLandlord
    }
  }
}
