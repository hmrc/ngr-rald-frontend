...
@Singleton
class TellUsAboutYourNewAgreementController @Inject()(view: TellUsAboutYourNewAgreementView,
  ...
  def show: Action[AnyContent] = {
    (authenticate andThen isRegisteredCheck).async { implicit request =>
      Future.successful(Ok(view(navigationBarContent = createDefaultNavBar, selectedPropertyAddress = "selectedPropertyAddress")))
    }
  }
